...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'accounts.context_processors.get_vendor_details',
...
DEFAULT_FROM_EMAIL = 'foodOnline Marketplace <sharmabhavesh97@gmail.com>'

GOOGLE_API_KEY ='AIzaSyDoaj5Eo6uomYae7UEhYy0JjLivrv6IhuI'
import os
#GDAL Config
